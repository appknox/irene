...
describe('Upload App', () => {
  beforeEach(() => {
    ...
    cy.intercept(API_ROUTES.uploadAppViaLink.route).as('uploadAppLinkReq');
  ...
  APP_TYPES.forEach((appType) =>
    it(
      `It successfully uploads an ${appType.type} file`,
      ...
      function () {
            ...
            .within(() => {
              ...
              function waitForAppSubFileResolution(attempts = 0) {
                ...
                cy.wait(
                  ...
                  appType.type === 'viaLink'
                    ? SUBMISSION_WAIT_OPTS
                    : NETWORK_WAIT_OPTS
        ...
        uploadAppActions.waitForSBOMProjectList(
          '@sbomProjectList',
          '@uploadedAppPrjID',
          '@uploadedFileDetails',
          '@uploadedAppPackageName'
