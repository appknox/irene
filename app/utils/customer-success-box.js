...
customerSuccessBox = function() {
  if(!ENV.enableCSB) {
    ...
    if (!analytics.initialize) if (analytics.invoked) window.console && console.error && console.error("CustomerSuccess snippet included twice."); 
        ...
        analytics.invoked = !0;
        analytics.methods = [
            "trackSubmit", "trackClick", "trackLink",
            "trackForm", "pageview", "identify", "reset",
            "group", "track", "ready", "alias", "debug",
            "page", "once", "off", "on"
        ];
        ...
        analytics.load = function (callback) {
            ...
            script.async = !0;
            script.src = "https://delivery.customersuccessbox.com/scripts/analytics.js";
