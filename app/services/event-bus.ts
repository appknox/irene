...
export default class EventBusService extends Service.extend(Evented) {
   ...
   * Original Ember signature for compatibility.
   *
   * @template T
   * @param {string} name - The name of the event
   * @param {T} target - The context object for the method
   * @param {EmberMethod<T>} method - The method to call (can be function or string method name)
   * @returns {this} Returns this for method chaining
   */
   ...
   * @param {string} name - The name of the event
   * @param {T} target - The context object for the method
   * @param {EmberMethod<T>} [method] - Optional method to unsubscribe (unsubscribes all if omitted)
   * @returns {this} Returns this for method chaining
   */
