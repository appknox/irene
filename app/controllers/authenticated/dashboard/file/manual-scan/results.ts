...
export default class AuthenticatedDashboardFileManualScanResultsController extends Controller {
  ...
  get breadcrumbs(): AkBreadcrumbsItemProps {
    ...
    const crumb: AkBreadcrumbsItemProps = {
      title: this.intl.t('manualScanResults'),
      route: 'authenticated.dashboard.file.manual-scan.results',
      siblingRoutes: ['authenticated.dashboard.file.manual-scan.index'],
      models: routeModels,
