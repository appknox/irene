...
export default class AuthenticatedDashboardFileApiScanIndexController extends Controller {
  ...
  get breadcrumbs(): AkBreadcrumbsItemProps {
    ...
    const crumb: AkBreadcrumbsItemProps = {
      title: this.intl.t('apiScan'),
      route: 'authenticated.dashboard.file.api-scan.index',
      models: routeModels,
      siblingRoutes: ['authenticated.dashboard.file.api-scan.results'],
