...
import type { PrivacyModuleTrackersModel } from 'irene/routes/authenticated/dashboard/privacy-module/app-details/index';
import type { AkBreadcrumbsItemProps } from 'irene/services/ak-breadcrumbs';

export default class AuthenticatedDashboardPrivacyModuleAppDetailsIndexController extends Controller {
  @service declare intl: IntlService;

  declare model: PrivacyModuleTrackersModel;
