...
import type { PrivacyModuleGeoLocationModel } from 'irene/routes/authenticated/dashboard/privacy-module/app-details/geo-location';
import type { AkBreadcrumbsItemProps } from 'irene/services/ak-breadcrumbs';

export default class AuthenticatedDashboardPrivacyModuleAppDetailsGeoLocationController extends Controller {
  @service declare intl: IntlService;

  declare model: PrivacyModuleGeoLocationModel;

  get breadcrumbs(): AkBreadcrumbsItemProps {
    return {
      title: this.model.file.name as string,
      route: 'authenticated.dashboard.privacy-module.app-details.geo-location',
