...
export interface OrganizationServiceAccountSectionAccountOverviewSignature {
  Args: {
...
export default class OrganizationServiceAccountSectionAccountOverviewComponent extends Component<OrganizationServiceAccountSectionAccountOverviewSignature> {
  ...
  constructor(
    owner: unknown,
    args: OrganizationServiceAccountSectionAccountOverviewSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Organization::ServiceAccount::Section::AccountOverview': typeof OrganizationServiceAccountSectionAccountOverviewComponent;
  }
}
