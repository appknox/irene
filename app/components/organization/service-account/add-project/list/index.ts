...
export default class OrganizationServiceAccountAddProjectListComponent extends Component<OrganizationServiceAccountAddProjectListComponentSignature> {
  ...
  constructor(
    owner: unknown,
    args: OrganizationServiceAccountAddProjectListComponentSignature['Args']
  ) {
    super(owner, args);
    ...
    return [
      {
        ...
        component: 'organization/service-account/add-project/list/name',
        minWidth: 250,
      },
      {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Organization::ServiceAccount::AddProject::List': typeof OrganizationServiceAccountAddProjectListComponent;
  }
}
