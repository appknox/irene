  ...
  get regulatoryCategories() {
    return [
      ...
      },
      {
        ...
        labelKeys: ['code', 'year', 'title'],
        selected: this.analysis?.owaspmobile2024 ?? [],
      ...
      },
      {
        ...
        selected: this.analysis?.owaspapi2023 ?? [],
      ...
      },
      {
        ...
        labelKeys: ['code', 'title'],
        selected: this.analysis?.pcidss4 ?? [],
      ...
      },
      {
        ...
        labelKeys: ['code', 'title'],
        selected: this.analysis?.nistsp800171 ?? [],
      ...
      },
      {
        ...
        labelKeys: ['code', 'title'],
        selected: this.analysis?.nistsp80053 ?? [],
