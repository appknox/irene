...
interface AdminUserManagementUsersTableMemberActionInviteDeleteSignature {
  Args: {
...
export default class AdminUserManagementUsersTableMemberActionInviteDelete extends Component<AdminUserManagementUsersTableMemberActionInviteDeleteSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'OrganizationMemberInvitationList::InviteDelete': typeof AdminUserManagementUsersTableMemberActionInviteDelete;
  }
}
