...
export interface AdminUserManagementEmailDomainRestrictionsComponentSignature {
  Args: {
    user: UserModel;
  };
  Blocks: {
...
export default class AdminUserManagementEmailDomainRestrictionsComponent extends Component<AdminUserManagementEmailDomainRestrictionsComponentSignature> {
  ...
  constructor(
    owner: unknown,
    args: AdminUserManagementEmailDomainRestrictionsComponentSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::UserManagement::EmailDomainRestrictions': typeof AdminUserManagementEmailDomainRestrictionsComponent;
  }
}
