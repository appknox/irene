...
export interface AdminServiceAccountListSignature {
  Args: {
...
export default class AdminServiceAccountListComponent extends Component<AdminServiceAccountListSignature> {
  ...
  constructor(owner: unknown, args: AdminServiceAccountListSignature['Args']) {
    super(owner, args);
  ...
  get columns() {
    return [
      ...
      },
      {
        ...
        component: 'admin/service-account/list/expiry-on',
      },
      {
      ...
      },
      {
        ...
        textAlign: 'center',
        width: 60,
        component: 'admin/service-account/list/action',
      },
    ];
  }
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::List': typeof AdminServiceAccountListComponent;
  }
}
