...
export interface AdminServiceAccountSectionAccountOverviewAuditInfoSignature {
  Args: {
    serviceAccount: ServiceAccountModel;
  };
}

export default class AdminServiceAccountSectionAccountOverviewAuditInfoComponent extends Component<AdminServiceAccountSectionAccountOverviewAuditInfoSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::AccountOverview::AuditInfo': typeof AdminServiceAccountSectionAccountOverviewAuditInfoComponent;
  }
}
