...
export interface AdminServiceAccountSectionAccessTokenSignature {
  Args: {
...
export default class AdminServiceAccountSectionAccessTokenComponent extends Component<AdminServiceAccountSectionAccessTokenSignature> {
  ...
  constructor(
    owner: unknown,
    args: AdminServiceAccountSectionAccessTokenSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::AccessToken': typeof AdminServiceAccountSectionAccessTokenComponent;
  }
}
