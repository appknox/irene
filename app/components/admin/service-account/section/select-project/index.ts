...
export interface AdminServiceAccountSectionSelectProjectSignature {
  Args: {
...
export default class AdminServiceAccountSectionSelectProjectComponent extends Component<AdminServiceAccountSectionSelectProjectSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::SelectProject': typeof AdminServiceAccountSectionSelectProjectComponent;
  }
}
