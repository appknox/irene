...
export interface AdminServiceAccountSectionSelectProjectListOverviewSignature {
  Args: {
...
export default class AdminServiceAccountSectionSelectProjectListOverviewComponent extends Component<AdminServiceAccountSectionSelectProjectListOverviewSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::SelectProject::List::Overview': typeof AdminServiceAccountSectionSelectProjectListOverviewComponent;
  }
}
