...
export interface AdminServiceAccountSectionSelectProjectListSignature {
  Args: {
...
export default class AdminServiceAccountSectionSelectProjectListComponent extends Component<AdminServiceAccountSectionSelectProjectListSignature> {
  ...
  constructor(
    owner: unknown,
    args: AdminServiceAccountSectionSelectProjectListSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::SelectProject::List': typeof AdminServiceAccountSectionSelectProjectListComponent;
  }
}
