...
export interface AdminServiceAccountSectionSelectScopeSignature {
  Args: {
...
export default class AdminServiceAccountSectionSelectScopeComponent extends Component<AdminServiceAccountSectionSelectScopeSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Admin::ServiceAccount::Section::SelectScope': typeof AdminServiceAccountSectionSelectScopeComponent;
  }
}
