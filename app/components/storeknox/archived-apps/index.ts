...
export default class StoreknoxArchivedAppsComponent extends Component {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Storeknox::ArchivedApps': typeof StoreknoxArchivedAppsComponent;
  }
}
