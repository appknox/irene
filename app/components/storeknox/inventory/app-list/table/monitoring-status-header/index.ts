...
export default class StoreknoxInventoryAppListTableMonitoringStatusHeaderComponent extends Component<StoreknoxInventoryAppListTableMonitoringStatusHeaderSignature> {
  ...
  get statusOptions() {
    return [
      ...
      {
        key: this.intl.t('storeknox.actionNeeded'),
        value: ENUMS.SK_MONITORING_STATUS_FILTER.ACTION_NEEDED,
      },
      {
        key: this.intl.t('storeknox.beingInitialized'),
        value: ENUMS.SK_MONITORING_STATUS_FILTER.INITIALIZING,
      },
      {
        key: this.intl.t('disabled'),
        value: ENUMS.SK_MONITORING_STATUS_FILTER.DISABLED,
      },
      {
        key: this.intl.t('storeknox.noActionNeeded'),
        value: ENUMS.SK_MONITORING_STATUS_FILTER.NO_ACTION_NEEDED,
      },
    ];
  }
