...
export default class StoreknoxInventoryDisabledAppsTableComponent extends Component {
  ...
  get columns() {
    return [
      ...
      },
      {
        ...
        cellComponent:
          'storeknox/inventory/disabled-apps/table/monitoring-status',
        width: 200,
      },
      {
        headerComponent:
          'storeknox/inventory/disabled-apps/table/availability-header',
        cellComponent: 'storeknox/inventory/disabled-apps/table/availability',
        textAlign: 'center',
      },
    ];
  }
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Storeknox::Inventory::DisabledApps::Table': typeof StoreknoxInventoryDisabledAppsTableComponent;
  }
}
