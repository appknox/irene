...
export interface StoreknoxFakeAppsFakeAppDetailsListSignature {
  Args: {
...
export default class StoreknoxFakeAppsFakeAppDetailsListComponent extends Component<StoreknoxFakeAppsFakeAppDetailsListSignature> {
  ...
  constructor(
    owner: unknown,
    args: StoreknoxFakeAppsFakeAppDetailsListSignature['Args']
  ) {
    super(owner, args);
  ...
  fetchFakeApps = task(async () => {
    ...
    try {
      ...
      if (this.args.status !== undefined) {
        query['status'] = this.args.status;
      }

      if (this.args.classification) {
        query['classification'] = this.args.classification;
      }
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'Storeknox::FakeApps::FakeAppDetails::List': typeof StoreknoxFakeAppsFakeAppDetailsListComponent;
  }
}
