...
export default class StoreknoxFakeAppsFakeAppListListComponent extends Component<StoreknoxFakeAppsFakeAppListListSignature> {
  ...
  get skFakeApps() {
    return this.skFakeAppsList.skFakeApps;
  }

  get isFetchingData() {
    return this.skFakeAppsList.isFetching;
  }

  get totalCount() {
    return this.skFakeAppsList.totalCount;
  }

  get limit() {
    return this.skFakeAppsList.limit;
  }

  get offset() {
    return this.skFakeAppsList.offset;
  }
  ...
  goToPage({ limit, offset }: PaginationProviderActionsArgs) {
    this.skFakeAppsList.setQueryParams({ limit, offset }).fetch.perform();
  }

  @action
  onItemPerPageChange({ limit }: PaginationProviderActionsArgs) {
    this.skFakeAppsList.setQueryParams({ limit, offset: 0 }).fetch.perform();
  }
}
