...
export default class AkTreeNodeComponent<
...
> extends Component<AkTreeSignature<N>> {
  ...
  @action getFlatNode(key?: string): AkTreeNodeFlattenedProps | undefined {
    ...
    if (this.tree.cascade) {
      this.setIndertiminateState(flatNode);
    }
   ...
   * @memberof AkTreeNodeComponent
   */
  @action setIndertiminateState(flatNode?: AkTreeNodeFlattenedProps) {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'AkTree::Node': typeof AkTreeNodeComponent;
  }
}
