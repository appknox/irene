...
export default class ProjectSettingsDastAutomationScenarioViewComponent extends Component<ProjectSettingsDastAutomationScenarioViewSignature> {
  ...
  constructor(
    owner: unknown,
    args: ProjectSettingsDastAutomationScenarioViewSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'ProjectSettings::DastAutomation::ScenarioView': typeof ProjectSettingsDastAutomationScenarioViewComponent;
  }
}
