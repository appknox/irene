...
interface ProjectSettingsDastAutomationScenarioViewParameterItemSignature {
  Args: {
...
export default class ProjectSettingsDastAutomationScenarioViewParameterItemComponent extends Component<ProjectSettingsDastAutomationScenarioViewParameterItemSignature> {
  ...
  constructor(
    owner: unknown,
    args: ProjectSettingsDastAutomationScenarioViewParameterItemSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'ProjectSettings::DastAutomation::ScenarioView::ParameterItem': typeof ProjectSettingsDastAutomationScenarioViewParameterItemComponent;
  }
}
