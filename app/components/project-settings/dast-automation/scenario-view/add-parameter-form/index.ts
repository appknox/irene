...
interface ProjectSettingsDastAutomationScenarioViewAddParameterSignature {
  Args: {
...
export default class ProjectSettingsDastAutomationScenarioViewAddParameterComponent extends Component<ProjectSettingsDastAutomationScenarioViewAddParameterSignature> {
  ...
  constructor(
    owner: unknown,
    args: ProjectSettingsDastAutomationScenarioViewAddParameterSignature['Args']
  ) {
    super(owner, args);
  ...
  createScanParameter = task(async () => {
    ...
    try {
      ...
      this.notify.error(parseError(errors, this.intl.t('somethingWentWrong')));
    }
  });
}
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'ProjectSettings::DastAutomation::ScenarioView::AddParameterForm': typeof ProjectSettingsDastAutomationScenarioViewAddParameterComponent;
  }
}
