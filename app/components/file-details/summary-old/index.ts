...
export interface FileDetailsSummaryOldSignature {
  Args: {
    file: FileModel;
  };
}
...
export default class FileDetailsSummaryOldComponent extends Component<FileDetailsSummaryOldSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'FileDetails::SummaryOld': typeof FileDetailsSummaryOldComponent;
  }
}
