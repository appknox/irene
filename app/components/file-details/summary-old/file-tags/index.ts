...
export interface FileDetailsSummaryOldFileTagsSignature {
  Args: {
    file: FileModel;
  };
}

export default class FileDetailsSummaryOldFileTagsComponent extends Component<FileDetailsSummaryOldFileTagsSignature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'FileDetails::SummaryOld::FileTags': typeof FileDetailsSummaryOldFileTagsComponent;
    'file-details/summary-old/file-tags': typeof FileDetailsSummaryOldFileTagsComponent;
  }
}
