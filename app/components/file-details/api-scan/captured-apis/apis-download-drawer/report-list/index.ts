...
export interface FileDetailsApiScanCapturedApisApisDownloadDrawerReportListSignature {
  Args: {
    file: FileModel | null;
  };
}

export default class FileDetailsApiScanCapturedApisApisDownloadDrawerReportListComponent extends Component<FileDetailsApiScanCapturedApisApisDownloadDrawerReportListSignature> {
  ...
  constructor(
    owner: unknown,
    args: FileDetailsApiScanCapturedApisApisDownloadDrawerReportListSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'FileDetails::ApiScan::CapturedApis::ApisDownloadDrawer::ReportList': typeof FileDetailsApiScanCapturedApisApisDownloadDrawerReportListComponent;
  }
}
