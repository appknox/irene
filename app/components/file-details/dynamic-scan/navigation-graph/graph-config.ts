...
// Layout values in display order. Labels are resolved via i18n at the use
// site (see nav-panel), keyed by the layout value.
export const GRAPH_LAYOUT_OPTIONS: { value: NavigationGraphLayout }[] = [
  { value: 'grid' },
  { value: 'breadthfirst' },
];
