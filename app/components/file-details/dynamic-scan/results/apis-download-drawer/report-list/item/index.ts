...
export interface FileDetailsDynamicScanResultsApisDownloadDrawerReportListItemSignature {
  Args: {
    file: FileModel | null;
...
export default class FileDetailsDynamicScanResultsApisDownloadDrawerReportListItemComponent extends Component<FileDetailsDynamicScanResultsApisDownloadDrawerReportListItemSignature> {
  ...
  constructor(
    owner: unknown,
    args: FileDetailsDynamicScanResultsApisDownloadDrawerReportListItemSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'FileDetails::DynamicScan::Results::ApisDownloadDrawer::ReportList::Item': typeof FileDetailsDynamicScanResultsApisDownloadDrawerReportListItemComponent;
  }
}
