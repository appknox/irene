...
export interface MainLoaderAiSignature {
  Element: HTMLElement;
}

export default class MainLoaderAiComponent extends Component<MainLoaderAiSignature> {
  @tracked fakeProgress = 0;
  @tracked currentLoaderImageIndex = 0;

  loaderImages = [
    'ak-svg/main-loader-ai-image1' as const,
    'ak-svg/main-loader-ai-image2' as const,
    'ak-svg/main-loader-ai-image3' as const,
  ];
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    MainLoaderAi: typeof MainLoaderAiComponent;
  }
}
