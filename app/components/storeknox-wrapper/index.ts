    ...
    return [
      {
        ...
        currentWhen:
          'authenticated.storeknox.inventory.app-list authenticated.storeknox.inventory.pending-reviews authenticated.storeknox.inventory-details.index authenticated.storeknox.inventory-details.unscanned-version authenticated.storeknox.inventory-details.unscanned-version.history authenticated.storeknox.inventory-details.unscanned-version.index authenticated.storeknox.inventory-details.brand-abuse authenticated.storeknox.inventory-details.malware-detected authenticated.storeknox.archived-apps',
      },
      {
      ...
      {
        label: this.intl.t('fakeApps'),
        icon: 'warning',
        route: 'authenticated.storeknox.fake-apps',
        currentWhen:
          'authenticated.storeknox.fake-apps.index authenticated.storeknox.fake-apps.fake-app-details',
      },
    ] as MenuItem[];
  }
