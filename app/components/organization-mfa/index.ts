...
export default class OrganizationMfaComponent extends Component<OrganizationMfaSignature> {
  ...
  constructor(owner: unknown, args: OrganizationMfaSignature['Args']) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    OrganizationMfa: typeof OrganizationMfaComponent;
  }
}
