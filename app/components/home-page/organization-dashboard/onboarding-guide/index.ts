...
interface OrganizationDashboardOnboardingGuideSignature {
  Args: {
    onClose: () => void;
  };
}
...
export default class OrganizationDashboardOnboardingGuide extends Component<OrganizationDashboardOnboardingGuideSignature> {
  ...
  constructor(
    owner: unknown,
    args: OrganizationDashboardOnboardingGuideSignature['Args']
  ) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'HomePage::OrganizationDashboard::OnboardingGuide': typeof OrganizationDashboardOnboardingGuide;
  }
}
