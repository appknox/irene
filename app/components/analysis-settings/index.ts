...
interface AnalysisSettingsSignature {
  Args: {
    project: ProjectModel | null;
  };
}

export default class AnalysisSettingsComponent extends Component<AnalysisSettingsSignature> {
  ...
  constructor(owner: unknown, args: AnalysisSettingsSignature['Args']) {
    super(owner, args);
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    AnalysisSettings: typeof AnalysisSettingsComponent;
    'analysis-settings': typeof AnalysisSettingsComponent;
  }
}
