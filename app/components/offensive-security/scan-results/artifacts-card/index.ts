...
export default class OffensiveSecurityScanResultsArtifactsCardComponent extends Component<OffensiveSecurityScanResultsArtifactsCardSignature> {
  ...
  @action
  getArtifactDescription(artifactOrName: OffsecScanArtifact | string) {
    const artifact =
  ...
  @action
  getArtifactIcon(artifactOrName: OffsecScanArtifact | string) {
    const artifact =
      typeof artifactOrName === 'object' && artifactOrName !== null
        ? artifactOrName
        : ({ name: artifactOrName } as Partial<OffsecScanArtifact>);
  ...
  @action
  getArtifactIconClass(artifactOrName: OffsecScanArtifact | string) {
    const artifact =
      typeof artifactOrName === 'object' && artifactOrName !== null
        ? artifactOrName
        : ({ name: artifactOrName } as Partial<OffsecScanArtifact>);
