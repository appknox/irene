...
export interface FileReportDrawerPrivacyModuleReportsSignature {
  Args: {
    file: FileModel;
    closeDrawer: () => void;
  };
...
export default class FileReportDrawerPrivacyModuleReportsComponent extends Component<FileReportDrawerPrivacyModuleReportsSignature> {
  ...
  constructor(
    owner: unknown,
    args: FileReportDrawerPrivacyModuleReportsSignature['Args']
  ) {
    super(owner, args);
    ...
    return [
      {
        ...
        type: 'pdf' as const,
        primaryText: 'Privacy Module Report (pdf)',
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'File::ReportDrawer::PrivacyModuleReports': typeof FileReportDrawerPrivacyModuleReportsComponent;
    'file/report-drawer/privacy-module-reports': typeof FileReportDrawerPrivacyModuleReportsComponent;
  }
}
