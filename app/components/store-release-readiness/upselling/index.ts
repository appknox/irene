...
export default class StoreReleaseReadinessUpsellingComponent extends Component {
  ...
  get features() {
    return [
      this.intl.t('storeReleaseReadinessModule.features.policyChecks'),
      this.intl.t('storeReleaseReadinessModule.features.riskVisibility'),
      this.intl.t('storeReleaseReadinessModule.features.remediationContext'),
      this.intl.t('storeReleaseReadinessModule.features.releaseDecisionSupport'),
    ];
  }
