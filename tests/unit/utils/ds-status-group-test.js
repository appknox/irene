...
module('Unit | Utility | ds-status-group', function () {
  ...
  // ─── Cumulative — two roles (Table 4) ───────────────────────────────────────

  test.each(
    'rolls up two roles into the cumulative bucket (Table 4)',
    [
  ...
  // ─── Cumulative — three roles (Table 5) ─────────────────────────────────────

  test.each(
    'rolls up three roles into the cumulative bucket (Table 5)',
    [
      [
  ...
  // ─── Cumulative — Cancelled edge cases (off-spec but defined) ───────────────
