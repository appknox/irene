...
module(
  ...
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      assert
        .dom('[data-test-fileCompare-fileOverview-severityValues]')
        .exists();
      ...
      const chartLegend = this.file.severityLevelCounts;

      chartLegend.forEach((data) => {
        const legendContainer = `[data-test-fileCompare-fileOverview-chartSeverity='${data.name}']`;

        assert.dom(legendContainer).exists();
