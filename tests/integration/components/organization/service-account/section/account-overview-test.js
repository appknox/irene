...
module(
  'Integration | Component | organization/service-account/section/account-overview',
  function (hooks) {
    ...
    test('it renders account overview', async function (assert) {
      await render(hbs`
        <Organization::ServiceAccount::Section::AccountOverview @serviceAccount={{this.serviceAccount}} />
      `);
