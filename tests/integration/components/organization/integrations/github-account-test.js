...
module(
  ...
  function (hooks) {
    ...
    test('it renders github-account not integrated', async function (assert) {
      ...
      assert
        .dom('[data-test-integration-card-title="Github"]')
        .hasText(t('github'));

      assert
        .dom('[data-test-integration-card-description="Github"]')
    ...
    test('it renders github-account integrated', async function (assert) {
      ...
      assert
        .dom('[data-test-orgIntegrations-githubAccount-disconnectBtn]')
        .isNotDisabled()
    ...
    test.each(
      ...
      async function (assert, { fail, error }) {
        ...
        await click('[data-test-orgIntegrations-githubAccount-disconnectBtn]');

        assert
          .dom('[data-test-orgIntegrations-githubAccount-drawer-title]')
