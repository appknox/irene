...
module(
  ...
  function (hooks) {
    ...
    test('it renders jira-account not integrated', async function (assert) {
      ...
      assert
        .dom('[data-test-integration-card-description="JIRA"]')
      ...
      assert
        .dom('[data-test-orgIntegrations-jiraAccount-drawer-title]')
      ...
      assert
        .dom('[data-test-orgIntegrations-jiraAccount-saveBtn]')
        .isNotDisabled()
        .hasText(t('save'));
    ...
    test('it renders jira-account integrated', async function (assert) {
      ...
      assert.dom('[data-test-integration-card-integrated-chip]').exists();
      ...
      assert
        .dom('[data-test-orgIntegrations-jiraAccount-disconnectBtn]')
        .isNotDisabled()
    ...
    test('it should validate jira-account inputs', async function (assert) {
      ...
      await click('[data-test-orgIntegrations-jiraAccount-saveBtn]');
