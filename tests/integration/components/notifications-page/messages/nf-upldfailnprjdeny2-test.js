...
module(
  ...
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(hbs`
        <NotificationsPage::Messages::NfUpldfailnprjdeny2 
      ...
      compareInnerHTMLWithIntlTranslation(assert, {
        selector: '[data-test-nf-upldfailnprjdeny2-primary-message]',
        message: t('notificationModule.messages.nf-upldfailnprjdeny2.primary', {
          platform_display: 'android',
          package_name: 'com.mfva.test',
          requester_username: 'appknox_requester',
          requester_role: 'member',
