...
module(
  ...
  function (hooks) {
    ...
    test('it should show approved state if namespace is approved and you if approver is current user', async function (assert) {
      ...
      assert.dom('[data-test-nf-nsreqstd2-primary-message]').hasText(
        t('notificationModule.messages.nf-nsreqstd2.primary', {
          current_requester_username: 'appknox_requester',
          platform_display: 'android',
          namespace_value: 'com.mfva.test',
          initial_requester_username: 'appknox_requester_previous',
      ...
      assert.dom('[data-test-nf-nsreqstd2-approved-message]').hasText(
        t('notificationModule.messages.nf-nsreqstd2.approved', {
          moderaterName: 'You',
        })
      );
      assert.dom('[data-test-nf-nsreqstd2-approved-icon]').exists();
    });
    ...
    test('it should show rejected state if namespace is rejected', async function (assert) {
      ...
      assert
        .dom('[data-test-nf-nsreqstd2-rejected-message]')
        .hasText(t('notificationModule.messages.nf-nsreqstd2.rejected'));

      assert.dom('[data-test-nf-nsreqstd2-rejected-icon]').exists();
    });
    ...
    test('it should show approve and reject for unmoderated namespace', async function (assert) {
      ...
      assert.dom('[data-test-nf-nsreqstd2-approve-button]').exists();

      assert.dom('[data-test-nf-nsreqstd2-reject-button]').exists();

      assert
        .dom('[data-test-nf-nsreqstd2-link]')
        .exists()
    ...
    test('it should approve namespace when approve is clicked for unmoderated namespace', async function (assert) {
      ...
      await click('[data-test-nf-nsreqstd2-approve-button]');

      assert.dom('[data-test-nf-nsreqstd2-approve-button]').doesNotExist();
      assert.dom('[data-test-nf-nsreqstd2-reject-button]').doesNotExist();
    ...
    test('it should reject namespace when reject is clicked for unmoderated namespace', async function (assert) {
      ...
      await click('[data-test-nf-nsreqstd2-reject-button]');
