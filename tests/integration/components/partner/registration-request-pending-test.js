...
module('Integration | Component | partner/registration-request-pending', function(hooks) {
  ...
  test('it renders relative time for created on date', async function(assert) {
    ...
    assert.equal(createdOnElem.title, createdOn.format("DD MMM YYYY HH:mm A"));
  });
  ...
  test('it renders invite button as success btn with title send invite email', async function(assert) {
    ...
    assert.dom("[data-test-pending-request-approve-button]").hasClass("is-success");
    assert.dom("[data-test-pending-request-approve-button]").hasAttribute("title");
  ...
  test('it renders reject button as primary btn with title reject request', async function(assert) {
    ...
    assert.dom("[data-test-pending-request-reject-button]").hasClass("is-primary");
    assert.dom("[data-test-pending-request-reject-button]").hasAttribute("title");
