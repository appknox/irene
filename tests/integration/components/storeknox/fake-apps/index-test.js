...
class SkAppsServiceStub extends Service {
  ...
  @tracked isFetchingSkFakeApps = false;
  @tracked limit = 10;
  @tracked offset = 0;
  @tracked searchQuery = '';
...
module('Integration | Component | storeknox/fake-apps', function (hooks) {
  ...
  hooks.beforeEach(async function () {
    ...
    const skApp1 = this.server.create('sk-fake-app-inventory', {
      id: '1',
    ...
    const skApp2 = this.server.create('sk-fake-app-inventory', {
      id: '2',
    ...
    this.skFakeAppInventory1Record = store.push(
    ...
    this.skFakeAppInventory2Record = store.push(
      store.normalize('sk-fake-app-inventory', {
        ...skApp2.toJSON(),
  ...
  test('it renders app cards when data is loaded', async function (assert) {
    this.skAppsService.skFakeApps = [
      this.skFakeAppInventory1Record,
      this.skFakeAppInventory2Record,
    ];

    this.skAppsService.skFakeAppsCount = 2;
  ...
  test('it renders the android store logo for android apps', async function (assert) {
    this.skAppsService.skFakeApps = [this.skFakeAppInventory1Record];
    this.skAppsService.skFakeAppsCount = 1;
  ...
  test('it renders the iOS store logo for iOS apps', async function (assert) {
    this.skAppsService.skFakeApps = [this.skFakeAppInventory2Record];
    this.skAppsService.skFakeAppsCount = 1;
  ...
  test('it hides pagination when in loading state', async function (assert) {
    this.skAppsService.isFetchingSkFakeApps = true;
    this.skAppsService.skFakeAppsCount = 20;
