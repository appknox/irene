...
module(
  ...
  function (hooks) {
    ...
    test('it renders the signal title, result, and reasoning', async function (assert) {
      await render(hbs`
        <Storeknox::FakeApps::SignalDetailDrawer
          @isOpen={{true}}
          @sectionTitle='Brand Identity Analysis'
    ...
    test('it renders the Signal, Result, and Reasoning labels translated', async function (assert) {
      await render(hbs`
        <Storeknox::FakeApps::SignalDetailDrawer
          @isOpen={{true}}
          @sectionTitle='Brand Identity Analysis'
