...
module('Acceptance | privacy-module/tracker', function (hooks) {
  ...
  test('it shows empty when no data', async function (assert) {
    ...
    assert.dom('[data-test-privacyModule-emptyState]').exists();

    assert
      .dom('[data-test-privacyModule-emptyState-header]')
      .exists()
      .hasText(t('privacyModule.emptyTrackersHeader'));

    assert
      .dom('[data-test-privacyModule-emptyState-desc]')
      .exists()
  ...
  test('it opens drawer and shows data', async function (assert) {
    ...
    assert
      ...
      .exists()
      .hasText(t('privacyModule.nameOfPermission'));
