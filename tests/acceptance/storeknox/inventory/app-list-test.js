...
const MONITORING_STATUSES = {
  UNSCANNED: ENUMS.SK_APP_MONITORING_STATUS.UNSCANNED,
  SCANNED: ENUMS.SK_APP_MONITORING_STATUS.SCANNED,
  PENDING: ENUMS.SK_APP_MONITORING_STATUS.PENDING,
};

const MONITORING_STATUS_FILTERS = {
  ALL: -1,
  DISABLED: ENUMS.SK_MONITORING_STATUS_FILTER.DISABLED,
  INITIALIZING: ENUMS.SK_MONITORING_STATUS_FILTER.INITIALIZING,
  ACTION_NEEDED: ENUMS.SK_MONITORING_STATUS_FILTER.ACTION_NEEDED,
  NO_ACTION_NEEDED: ENUMS.SK_MONITORING_STATUS_FILTER.NO_ACTION_NEEDED,
};
