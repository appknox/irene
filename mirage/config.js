...
function routes() {
  ...
  // namespace api
  this.get('/api/organizations/:id/projects', (schema, request) => {
    console.log('projects req', schema.projects.all())
    return schema.projects.all().models;
  });

  this.get('/api/profiles/:id/unknown_analysis_status', (schema, request) => {
    console.log('requ uknown', schema.unknownAnalysisStatuses.find(1))
  });

  this.namespace_v2 = config.namespace_v2;
