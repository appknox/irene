...
const ENVHandlerCONST = {
  ...
  defaults: {
    ...
    IRENE_POSTHOG_API_KEY: 'ksjjakejshdj',
    IRENE_POSTHOG_API_HOST: 'host.posthog.com',
    ENTERPRISE: false,
...
module.exports = function (environment) {
  ...
  var ENV = {
    ...
    posthogApiKey: handler.getValueForPlugin('IRENE_POSTHOG_API_KEY'),
    posthogApiHost: handler.getValueForPlugin('IRENE_POSTHOG_API_HOST'),
    emberRollbarClient: {
