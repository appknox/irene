...
module.exports = function(environment) {
  ...
  ENV.contentSecurityPolicy = {
    ...
    "frame-src": "'self' *.uservoice.com",
    "report-uri": "'self'",
    'img-src': "'self' www.gravatar.com placehold.it storage.googleapis.com s3.amazonaws.com *.cloudfront.net *.amazonaws.com",
    'style-src': "'self' 'unsafe-inline'",
    'script-src': "'self' 'unsafe-eval' localhost:35729 0.0.0.0:35729 storage.googleapis.com *.uservoice.com *.uvcdn.com *.amazonaws.com *.cloudfront.net"
  };
