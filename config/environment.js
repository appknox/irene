...
module.exports = function (environment) {
  var devicefarmEnv =
    process.env.IRENE_DEVICEFARM_URL || "wss://devicefarm.appknox.com";
  ...
  var socketPath =
    process.env.IRENE_API_SOCKET_PATH || "https://socket.appknox.com";
  var enableRegistration = isTrue(
    process.env.IRENE_ENABLE_REGISTRATION || false
  );
  ...
  var stripePublicKey =
    process.env.STRIPE_PK || "pk_test_IMZbFpQo6Uavs7Q77Udp7E8u00c1dRKOsd";
  var ENV = {
    version: Date.now(),
    isDevknox: false,
    isAppknox: false,
